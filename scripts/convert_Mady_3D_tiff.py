...
def convert(
    ...
    # Split out_array into zarr_root and internal_path  
    if ".zarr" in out_array:
        zarr_root, *internal = out_array.split(".zarr", 1)
        zarr_root += ".zarr"
        internal_path = internal[0].lstrip("/") if internal else ""
    else:
        zarr_root = out_array
        internal_path = ""
...
# python /home/S-EK/boundary_issues/scripts/convert_erika_data.py -i 20230807_gap43mCh_Tm3_T50-53_Z15-30.tif -o crop1.zarr/raw -vs 1000 170 170 -u nm nm nm